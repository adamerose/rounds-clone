...
| `S6-match` | reproduce round, half, score, color handoff, match completion and rematch cadence | blue 4–5 victory/rematch/0–0 reset continues through the first full-round award at recording `453954a7…a18c` PTS 2506156642; either color may sweep the opening fights or win the deciding ice duel; a same-tick double elimination provisionally repeats the fight without an award because neither recording shows one; next draft and remaining lifecycle unresolved |
