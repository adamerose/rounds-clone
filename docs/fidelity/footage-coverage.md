...
| `S6-match` | reproduce round, half, score, color handoff, match completion and rematch cadence | blue 4–5 victory/rematch/0–0 reset continues through the first full-round award at recording `453954a7…a18c` PTS 2506156642, though that 4–5 is hard-coded prior state; either color may sweep the opening fights or win the deciding ice duel; an unobserved same-tick double elimination provisionally repeats the fight without an award; match completion, next draft and remaining lifecycle unresolved |
