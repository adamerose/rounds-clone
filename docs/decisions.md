...
Ticket 041 binds recording `453954a7…a18c` from 02:40.00–03:20.00 to the first authoritative match-shell slice: blue's visible 5–4 victory, one rematch vote per client, a both-yes reset to 0–0 with old loadouts cleared, alternating five-card presentations, orange's `DAZZLE` choice, blue's `EXPLOSIVE BULLET` choice, and the return to upgraded combat.
